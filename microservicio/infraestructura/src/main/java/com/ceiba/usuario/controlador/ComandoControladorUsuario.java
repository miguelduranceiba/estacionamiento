...
public class ComandoControladorUsuario {
    ...
    public ComandoRespuesta<Integer> actualizar(@RequestBody ComandoUsuario comandoUsuario, @PathVariable Long id) {
        comandoUsuario.setId(id);
        return manejadorActualizarUsuario.ejecutar(comandoUsuario);
    }
}
